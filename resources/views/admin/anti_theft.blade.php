...
@section('title', 'Протизламні вікна')
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('edit-anti_theft.destroy', ['id' => $photo->id]) }}"  method="POST">
                                    @csrf
                                    @method('DELETE')
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('edit-anti_theft.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('POST')
