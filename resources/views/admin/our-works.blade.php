                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('edit-our-works.destroy', ['id' => $photo->id]) }}"  method="POST">
                                    @csrf
                                    @method('DELETE')
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('edit-our-works.store') }}" enctype="multipart/form-data" method="POST" required>
                    @csrf
                    @method('POST')
                    <div class="form-group">

                        <label for="File1">Підтримуванні формати: jpeg, jpg, png</label>
                        <input type="file" name="photo" required class="form-control-file" id="File1">
                    </div>
            </div>
